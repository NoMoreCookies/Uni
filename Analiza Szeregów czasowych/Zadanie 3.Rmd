...
```
Test graficzny jednoznacznie stwierdza na brak białoszumowego charakteru danych

Co potwierdzają również test Boxa-Persea oraz Ljunga-Boxa jednoznacznei zwracając FALSE (dane nie są białym szumem).
